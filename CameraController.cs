...
public class CameraController : MonoBehaviour {
	...
	void Start () {
        offset = transform.position - aaa.transform.position;
	...
	void Update () {
        transform.position = aaa.transform.position + offset;
        //Quaternion angel = Quaternion.LookRotation(transform.position + aaa.transform.position);
...
{
    public GameObject aaa;
    private Vector3 offset = new Vector3(0, 5, 0);//相机相对于玩家的位置
